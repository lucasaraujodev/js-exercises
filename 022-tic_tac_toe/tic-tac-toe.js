...
🇺🇸: Build a tic-tac-toe game, known in Portuguese as tic-tac-toe, using HTML, CSS and Javascript. You can develop freely, however you prefer, but the game must meet the following requirements:
...
- When a player clicks on the board, an “X” or “O” must be marked according to the current player and it must not be possible to click on that region again;
